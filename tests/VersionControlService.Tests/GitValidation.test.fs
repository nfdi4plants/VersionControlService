module VersionControlService.Tests.GitValidationTests
...
Vitest.describe (
    ...
    fun () ->
        let cases = [|
            ...
            "maps duplicate remote project message",
...
Vitest.describe (
    ...
    fun () ->
        ...
        let invalidCases = [|
            ...
            "rejects unsupported protocol", "git://github.com/example/version-control-service.git"
            "rejects SCP-style ssh remote", "git@github.com:example/version-control-service.git"
