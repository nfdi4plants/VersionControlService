module VersionControlService.Tests.GitServiceTests

open System
open Fable.Core
open Fable.Core.JsInterop
open VersionControlService.Bindings.SimpleGit
open VersionControlService.Support.FileSystemIO
...
module GitRemoteProvisioningProvider = VersionControlService.Git.GitTokenProvider.RemoteProvisioning
module GitTokenProvider = VersionControlService.Git.GitTokenProvider
module JsonDecoder = VersionControlService.Git.JsonDecoder
...
Vitest.describe (
    ...
    fun () ->
        ...
        Vitest.test (
            "push publishes a local repository by creating origin through the active remote provisioning provider",
            gitServiceIntegrationTestOptions,
            fun () -> promise {
                do!
                    withTempRepository (fun context -> promise {
        ...
        Vitest.test (
            "push reports the remote repository creation error when the publish target already exists",
            fun () -> promise {
                do!
                    withTempRepository (fun context -> promise {
